                ...
                <div className="flex flex-row align-baseline mt-5 justify-between">
                    <div className="flex flex-row gap-20 ml-4">
                      ...
                      >
                        ...
                        <p className="text-sm">{post.post.childids || 0}</p>
                      </button>
                      ...
                      {/* Like (already liked) */}
                      {user != null && post.post.likeIds.indexOf(user.id) !== -1 && (
                          <div className="flex flex-row gap-2 cursor-pointer"
                               onClick={() => {handleUnlike(post.post.id);}}>
                    ...
                    <div className="flex flex-row gap-3 mr-4">
                      ...
                      { user && user.bookmarks.indexOf(post.post.id) !== -1 && (
                          <div className="fill-text-secondary duration-75 ease-in hover:text-accent-blue-light hover:fill-accent-blue-light flex flex-row gap-3 cursor-pointer"
                               onClick={() => {handleUnBookmark(post.post.id);}}>
                            <svg className="fill-accent-blue" width="20px" height="20px" zoomAndPan="magnify" viewBox="0 0 810 809.999993" preserveAspectRatio="xMidYMid meet" version="1.0"><defs>
                              <clipPath id="42f0bbd39a"><path d="M 182.03125 162 L 628 162 L 628 600.941406 L 182.03125 600.941406 Z M 182.03125 162 " clip-rule="nonzero"/></clipPath>
                              <clipPath id="e1a312a0d5"><path d="M 220.28125 162 L 589.71875 162 C 599.863281 162 609.59375 166.03125 616.765625 173.203125 C 623.9375 180.375 627.96875 190.105469 627.96875 200.25 L 627.96875 562.691406 C 627.96875 572.835938 623.9375 582.5625 616.765625 589.738281 C 609.59375 596.910156 599.863281 600.941406 589.71875 600.941406 L 220.28125 600.941406 C 210.136719 600.941406 200.40625 596.910156 193.234375 589.738281 C 186.0625 582.5625 182.03125 572.835938 182.03125 562.691406 L 182.03125 200.25 C 182.03125 190.105469 186.0625 180.375 193.234375 173.203125 C 200.40625 166.03125 210.136719 162 220.28125 162 Z M 220.28125 162 " clip-rule="nonzero"/></clipPath>
                              <clipPath id="c7ae287a16"><path d="M 167 480 L 381 480 L 381 726 L 167 726 Z M 167 480 " clip-rule="nonzero"/></clipPath>
                              <clipPath id="37cce30e0d"><path d="M 167.933594 480.6875 L 381.085938 598.109375 L 278.492188 784.34375 L 65.339844 666.921875 Z M 167.933594 480.6875 " clip-rule="nonzero"/></clipPath>
                              <clipPath id="8d262d0206"><path d="M 171.757812 725.546875 L 380.773438 597.9375 L 167.933594 480.6875 Z M 171.757812 725.546875 " clip-rule="nonzero"/></clipPath>
                              <clipPath id="951f95fecf"><path d="M 423 479 L 636 479 L 636 725 L 423 725 Z M 423 479 " clip-rule="nonzero"/></clipPath>
                              <clipPath id="20ec417e27"><path d="M 423.480469 598.828125 L 635.613281 479.574219 L 739.808594 664.921875 L 527.671875 784.171875 Z M 423.480469 598.828125 " clip-rule="nonzero"/></clipPath>
                              <clipPath id="8b8040f67b"><path d="M 633.585938 724.632812 L 635.304688 479.75 L 423.480469 598.828125 Z M 633.585938 724.632812 " clip-rule="nonzero"/></clipPath></defs>
                      ...
                      { user && user.bookmarks.indexOf(post.post.id) == -1 && (
                          <div className="fill-text-secondary duration-75 ease-in hover:text-accent-blue-light hover:fill-accent-blue-light flex flex-row gap-3 cursor-pointer"
                               onClick={() => {handleBookmark(post.post.id);}}>
                            <svg width="20px" height="20px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
