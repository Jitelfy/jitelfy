            ...
            <div className="flex flex-col bg-background-secondary p-4 rounded-md mb-8 mx-10 gap-5">
                <div className="flex flex-row mb-3">
                    ...
                    <div className="flex flex-col w-full items-center justify-end gap-3 fill-white">
                        <textarea id="posttext" rows="3" className="resize-none bg-background-main w-full mt-1 text-text-main rounded-lg border border-background-tertiary p-2 focus:outline-none focus:ring-2 focus:ring-accent-blue" placeholder="What's on your mind?">
                        </textarea>
                        <input
                            type="url"
                            value={newPostSong}
                ...
                <div className="flex flex-row items-center justify-between ml-6 mr-6">
                    <div className="fill-white flex flex-row gap-5">
                        ...
                        <svg height="25px" width="25px" version="1.1" xmlns="http://www.w3.org/2000/svg"
                             viewBox="0 0 250.574 250.574">
                        <path d="M243.074,206.6h-15.493v-78.833c0-7.444-6.056-13.5-13.5-13.5h-34.196c-7.444,0-13.5,6.056-13.5,13.5
